...
export function EmployeeDetails() {
  ...
  let employeeCreationDate = new Date(employee._createdOn)
    .toString()
    .slice(4, 15);

  let percentageOwnedByEmployee = undefined;

  if (totalOkrs.current !== 0 && employeeOwnedOkrs.length !== 0) {
    percentageOwnedByEmployee =
      Math.trunc((employeeOwnedOkrs.length / totalOkrs.current) * 100) + "%";
  }
      ...
      <section className="okr-detailed">
        <div className="okr-detailed-ctr">
          ...
          <div className="okr-detailed-main-ctr teams-detailed-main-ctr">
            ...
            <div className="okr-detailed-field-ctr">
              ...
              <input
                ...
                placeholder="-"
                defaultValue={
                  employeeCreationDate.length !== 8 ? employeeCreationDate : ""
                }
              />
            </div>
            <div className="okr-detailed-fields">
              <div className="okr-detailed-field-ctr">
                <label htmlFor="">Managed teams</label>
          ...
          <div className="team-detailed-team-achievements-ctr">
            <p className="team-achievements-p">OKR ownership</p>
